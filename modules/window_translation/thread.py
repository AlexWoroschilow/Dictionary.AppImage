...
class TranslatorThread(QtCore.QThread):
    ...
    def run(self, dictionary, config):
        ...
        for index, translation in enumerate(dictionary.translate(self.string), start=1):
        ...
        for index, suggestion in enumerate(dictionary.suggestions(self.string), start=1):
